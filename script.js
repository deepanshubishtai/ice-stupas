...
function updateSidebar(location) {
    ...
    if (location.stats) {
        statsHTML = `
            <div class="village-stats">
                <h3>Site Details & Performance Metrics</h3>
    ...
    sidebarContent.innerHTML = `
        <div class="location-info">
            ...
            ${statsHTML}
            <div class="citation">
                <p>Source: Acres of Ice AIR Project Report 2024-25</p>
            </div>
        </div>
    `;
    ...
    style.textContent = `
        ...
        .sidebar {
            width: 450px !important;  /* Increased from default width */
            max-width: 80vw;          /* Responsive fallback for mobile */
            right: -450px;            /* Starting position off screen */
        }
        ...
        /* Adjust the sidebar content for better readability with wider space */
        .sidebar-content {
            padding: 1.5rem;
        }
...
function shareOnTwitter() {
    ...
    const text = encodeURIComponent('Explore the Automated Ice Reservoir (AIR) projects in Ladakh - innovative water management solutions for high-altitude communities facing climate change. With ice volumes up to 46 lakh litres, this technology is transforming water security in the Himalayas.');
